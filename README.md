...
L'objectif de ce projet est de définir les spécifications de l’API REST (FHIR) pour alimenter et interroger l'entrepôt de données de santé qui recensera les données de chimiothérapie. 
