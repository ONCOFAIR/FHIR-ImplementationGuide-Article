...
* rest[1].resource[=].searchParam[+].name = "identifier"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/Patient-identifier"
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Identifier of the patient"
...
* rest[1].resource[=].searchParam[+].name = "identifier"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/clinical-identifier"
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Identifier of the patient's stay"
...
* rest[1].resource[=].searchParam[+].name = "_filter"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/Resource-filter"
* rest[1].resource[=].searchParam[=].type = #special
* rest[1].resource[=].searchParam[=].documentation = "Filter search parameter that supports a more sophisticated search grammar. See [documentation](https://hl7.org/fhir/search_filter.html) for more details."

* rest[1].resource[=].searchParam[+].name = "_has"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/Resource-has"
* rest[1].resource[=].searchParam[=].type = #special
* rest[1].resource[=].searchParam[=].documentation = "Enables resources to be selected on the basis of the properties of the resources that refer to them (reverse chaining)."

* rest[1].resource[=].searchParam[+].name = "_id"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/Resource-id"
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Logical resource identifier"
...
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Identifies the prescribed component according to a nomenclature depending on the type"

* rest[1].resource[=].searchParam[+].name = "medication-type"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-medication-type)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Specifies whether the component prescribed is a speciality, a common name or any other product (pharmacopoeia)."
...
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/clinical-identifier"
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Identifier"

* rest[1].resource[=].searchParam[+].name = "wording"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-wording)
* rest[1].resource[=].searchParam[=].type = #string
* rest[1].resource[=].searchParam[=].documentation = "Wording of element/component"

* rest[1].resource[=].searchParam[+].name = "indication"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-indication)
* rest[1].resource[=].searchParam[=].type = #string
* rest[1].resource[=].searchParam[=].documentation = "Indications concerning the prescription item and the component prescribed"


// MedicationRequestPrescription
* rest[1].resource[=].searchParam[+].name = "mr-prescription-validation-date"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-prescription-validation-date)
* rest[1].resource[=].searchParam[=].type = #date
* rest[1].resource[=].searchParam[=].documentation = "Date and time at which the prescriber considered the prescription validated"

// MedicationRequestElement
* rest[1].resource[=].searchParam[+].name = "mr-type-elementprescription"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-type-elementprescrption)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Type of prescription element"

* rest[1].resource[=].searchParam[+].name = "element-form"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-element-form)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Pharmaceutical form of the prescription item"

* rest[1].resource[=].searchParam[+].name = "status"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/medications-status"
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Indicates the status of the protocol from the prescriber's point of view"

* rest[1].resource[=].searchParam[+].name = "element-route"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-element-route)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Specifies the route of administration of the product"

* rest[1].resource[=].searchParam[+].name = "element-site"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-element-site)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Specifies, where appropriate, the exact point on the body where the product is to be applied to the patient"

* rest[1].resource[=].searchParam[+].name = "combo-date"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/MedicationRequest-combo-date"
* rest[1].resource[=].searchParam[=].type = #date
* rest[1].resource[=].searchParam[=].documentation = "Returns medication request to be administered on a specific date or within a date range"

* rest[1].resource[=].searchParam[+].name = "mr-date-time-prescription-start"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-date-time-prescription-start)
* rest[1].resource[=].searchParam[=].type = #date
* rest[1].resource[=].searchParam[=].documentation = "Effective start date and time of product prescription"

* rest[1].resource[=].searchParam[+].name = "mr-date-time-prescription-end"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-date-time-prescription-end)
* rest[1].resource[=].searchParam[=].type = #date
* rest[1].resource[=].searchParam[=].documentation = "Effective end date and time of product prescription"

* rest[1].resource[=].searchParam[+].name = "mr-element-gonogo-status"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-element-gonogo-status)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Communicates the conditional state of implementation of the prescription element according to a list of coded values"

* rest[1].resource[=].searchParam[+].name = "mr-element-gonogo-reasonwaiting"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-element-gonogo-reasonwaiting)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Describes the reason for the goNogo implementation status of the prescription element if the management option via the goNogo attribute is enabled"

* rest[1].resource[=].searchParam[+].name = "group-identifier"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/MedicationRequest-group-identifier"
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Identifier common to all components of the same prescription"

* rest[1].resource[=].searchParam[+].name = "mr-element-frequency-posology"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-element-frequency-posology)
* rest[1].resource[=].searchParam[=].type = #number
* rest[1].resource[=].searchParam[=].documentation = "Indicates the recurrence of the dosage. By default, every day"

* rest[1].resource[=].searchParam[+].name = "mr-element-duration-posology"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-element-duration-posology)
* rest[1].resource[=].searchParam[=].type = #number
* rest[1].resource[=].searchParam[=].documentation = "Duration of administration"

* rest[1].resource[=].searchParam[+].name = "mr-element-rate-posology"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-element-rate-posology)
* rest[1].resource[=].searchParam[=].type = #quantity
* rest[1].resource[=].searchParam[=].documentation = "Rate of administration in the case of injection"

* rest[1].resource[=].searchParam[+].name = "mr-element-quantity-posology"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-element-quantity-posology)
* rest[1].resource[=].searchParam[=].type = #quantity
* rest[1].resource[=].searchParam[=].documentation = "Quantity of the prescription element in the dosage"

// MedicationRequest Component

* rest[1].resource[=].searchParam[+].name = "mr-prescribed-component-quantity"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-prescribed-component-quantity)
* rest[1].resource[=].searchParam[=].type = #quantity
* rest[1].resource[=].searchParam[=].documentation = "Quantity of the component prescribed in the prescription element"

* rest[1].resource[=].searchParam[+].name = "mr-component-substitution"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-component-substitution)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "True if the component prescribed is declared non-substitutable in the prescription element"

* rest[1].resource[=].searchParam[+].name = "mr-is-dosage-referent"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-is-dosage-referent)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "True if the component prescribed is the component that refers to the quantity or flow rate expressed in the dosage element when these are gravimetric (for example, mg or mg/h)."

* rest[1].resource[=].searchParam[+].name = "mr-exempt-ltc"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-exempt-ltc)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Identifier of the ALD for which the component prescribed is prescribed for one of the reasons for which the patient benefits from an exemption under article L324-1 of the CSS."

* rest[1].resource[=].searchParam[+].name = "mr-component-solute"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-mr-component-solute)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "True if the component prescribed is solute in the prescription element"
...
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/clinical-identifier"
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Prescribed protocol identifier"

* rest[1].resource[=].searchParam[+].name = "cp-title"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-cp-title)
* rest[1].resource[=].searchParam[=].type = #string
* rest[1].resource[=].searchParam[=].documentation = "Wording of the prescribed protocol"

* rest[1].resource[=].searchParam[+].name = "status"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/CarePlan-status"
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Indicates the status of the protocol from the prescriber's point of view"

* rest[1].resource[=].searchParam[+].name = "cp-date-time-reference"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-cp-date-time-reference)
* rest[1].resource[=].searchParam[=].type = #date
* rest[1].resource[=].searchParam[=].documentation = "Reference date and time of this prescribed protocol"

* rest[1].resource[=].searchParam[+].name = "indication"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-indication)
* rest[1].resource[=].searchParam[=].type = #string
* rest[1].resource[=].searchParam[=].documentation = "Indication concerning the prescribed protocol"
...
* rest[1].resource[=].searchParam[+].name = "ma-method"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-ma-method)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Type of administration element"

* rest[1].resource[=].searchParam[+].name = "ma-category"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-ma-category)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Code identifying the nature of the administration element"

* rest[1].resource[=].searchParam[+].name = "element-form"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-element-form)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Pharmaceutical form of the administration item"
...
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-element-site)
* rest[1].resource[=].searchParam[=].type = #token
* rest[1].resource[=].searchParam[=].documentation = "Specifies, where applicable, the exact point on the body where the product is to be applied to the patient. By default, the place of administration is that shown in the prescription element associated with the administration element"

// Medication Administration Component

* rest[1].resource[=].searchParam[+].name = "date"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/medications-date"
* rest[1].resource[=].searchParam[=].type = #date
* rest[1].resource[=].searchParam[=].documentation = "Effective date and time for starting/ending administration of the administration element"

* rest[1].resource[=].searchParam[+].name = "ma-comments"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-ma-comments)
* rest[1].resource[=].searchParam[=].type = #string
* rest[1].resource[=].searchParam[=].documentation = "Comments of component"

* rest[1].resource[=].searchParam[+].name = "ma-planned-quantity"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-ma-planned-quantity)
* rest[1].resource[=].searchParam[=].type = #quantity
* rest[1].resource[=].searchParam[=].documentation = "Quantity of the component administered in the administration element that was intended to be administered to the patient"

* rest[1].resource[=].searchParam[+].name = "ma-prescribed-quantity"
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-ma-prescribed-quantity)
* rest[1].resource[=].searchParam[=].type = #quantity
* rest[1].resource[=].searchParam[=].documentation = "Quantity actually administered to the patient or planned to be administered"
...
* rest[1].resource[=].searchParam[=].definition = Canonical(oncofair-sp-wording)
* rest[1].resource[=].searchParam[=].type = #string
* rest[1].resource[=].searchParam[=].documentation = "Wording of component/element of administration"

// Medication Administration Report

* rest[1].resource[=].searchParam[+].name = "performer"
* rest[1].resource[=].searchParam[=].definition = "http://hl7.org/fhir/SearchParameter/MedicationAdministration-performer"
