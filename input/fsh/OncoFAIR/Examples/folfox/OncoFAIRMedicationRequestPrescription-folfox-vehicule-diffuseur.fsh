Instance: PrescriptionFolfox-vehicule-diff
InstanceOf: OncoFAIRMedicationRequestPrescription
Title: "Perfusion difuseur OncoFAIR MedicationRequest Prescription"
...
* identifier.value = "prescription-folfox-vehicule"
