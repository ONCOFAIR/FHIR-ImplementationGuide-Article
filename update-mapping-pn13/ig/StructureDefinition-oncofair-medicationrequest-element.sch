...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:MedicationRequest/f:medication/f:concept/f:coding</sch:title>
    <sch:rule context="f:MedicationRequest/f:medication/f:concept/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationRequest/f:effectiveDosePeriod</sch:title>
    <sch:rule context="f:MedicationRequest/f:effectiveDosePeriod">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationRequest/f:dosageInstruction/f:timing/f:event</sch:title>
